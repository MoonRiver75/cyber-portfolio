export default function Contact() {
  return (
    ...
    >
      <div className="container-cyber relative overflow-hidden border bg-surface p-8 shadow-[0_0_40px_rgba(0,251,251,0.15)] lg:p-12" style={{ borderColor: 'rgba(0,251,251,0.4)' }}>
        <div
        ...
        <div className="relative z-10 flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
          <div className="flex max-w-2xl flex-col gap-2">
            <div className="flex items-center gap-2 font-code text-[10px] font-bold uppercase tracking-widest text-primary-fixed">
              ...
              <span>[UPLINK_READY // TRANSMISSION_TERMINAL]</span>
            </div>
            <h3 className="font-headline-lg uppercase tracking-tight text-primary">
              Initialize Direct Enterprise Collaboration
            </h3>
            <p className="font-body-md leading-relaxed text-on-surface-variant">
              Available for AI project leadership, enterprise generative transformations, advisory on
              RAG and LLM-as-a-Judge systems, and high-impact software engineering initiatives.
            </p>
            <div className="flex flex-col gap-1 pt-1 font-code text-[14px]">
              <div className="flex items-center gap-2 text-on-surface">
                <span className="text-primary-fixed">&gt; EMAIL:</span>
              ...
              <div className="flex items-center gap-2 text-on-surface">
                <span className="text-tertiary-fixed-dim">&gt; BASE_LOC:</span>
                <span className="text-on-surface-variant">Guadalajara, Jalisco, Mexico</span>
              </div>
            </div>
          </div>
