    ...
    <footer className="relative w-full overflow-hidden border-t border-surface-light bg-surface-container-lowest py-12">
      <div className="container-cyber relative z-10 flex flex-col items-center justify-between gap-6 md:flex-row">
        <div className="flex flex-col items-center gap-1 md:items-start">
          <div className="flex items-center gap-2 border border-tertiary-fixed-dim/30 bg-surface-container px-3 py-1 font-code text-[12px] font-medium uppercase tracking-widest text-tertiary-fixed-dim shadow-[0_0_10px_rgba(57,255,20,0.2)]">
